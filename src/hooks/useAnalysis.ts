  ...
  const analyze = useCallback(async (url: string) => {
    ...
    try {
      ...
      const data: LeadScoreResult = {
        ...
        mediana_visitas_mensuales:  s.mediana_visitas_mensuales  ?? 0,
        ...
        m1_to_median_growth_pct:    s.m1_to_median_growth_pct ?? null,
        ...
        email_tool_source:     s.email_tool_source     ?? null,
        email_data_confidence: s.email_data_confidence ?? 0,
